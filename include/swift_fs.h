 ...
 */
void *swifthal_fs_open(char *path, unsigned char flags);
 ...
 * @retval -ERRNO errno code if error
 */
int swifthal_fs_remove(char *path);
 ...
 * @retval -ERRNO errno code if error
 */
int swifthal_fs_rename(char *from, char *to);
 ...
 * @retval -ERRNO errno code if error
 */
int swifthal_fs_mkdir(char *path);
 ...
 */
void *swifthal_fs_opendir(char *path);
 ...
 * @retval -ERRNO errno code if error
 */
int swifthal_fs_stat(char *path, swift_fs_dirent_t *entry);
 ...
 * @retval -ERRNO errno code if error
 */
int swifthal_fs_statfs(char *path, swift_fs_statvfs_t *stat);
