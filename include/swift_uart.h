 ...
 * @retval Negative errno code if failure.
 */
int swifthal_uart_char_put(void *uart, char c);
 ...
 * @retval Negative errno code if failure.
 */
int swifthal_uart_char_get(void *uart, char *c, int timeout);
 ...
 * @retval Negative errno code if failure.
 */
int swifthal_uart_write(void *uart, const char *buf, int length);
 ...
 * @retval Negative errno code if failure.
 */
int swifthal_uart_read(void *uart, char *buf, int length, int timeout);
